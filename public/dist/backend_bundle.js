...
var Backend = React.createClass({displayName: "Backend",
            ...
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "units", style: {overflow:'hidden'}}, 
                    ...
                    React.createElement("div", {className: "frame-legend"}, 
                        React.createElement("div", null, "Frame"), 
                        bars
                    ), 

                    this.state.data.units.map(function(unit) {
                        return (
                            React.createElement(Unit, {key: unit.id, frameStart: frameStart, frameEnd: frameEnd, unit: unit})
                        )
                    })
                )
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "unit"}, 
                React.createElement("div", null, "Player ", this.props.unit.id), 
                blocks
            )
        );
    }
...
React.render(
    React.createElement(Backend, null),
